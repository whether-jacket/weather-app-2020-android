...
import com.seljabali.theming.landingpage.ThemingLandingPageFragment

class ThemingActivity : BaseToolbarActivity() {
    ...
    fun showFragment(baseFragment: androidx.fragment.app.Fragment, tag: String) {
        supportFragmentManager.beginTransaction()
                ...
                .add(R.id.design_activity_frame_layout, baseFragment)
                .addToBackStack(tag)
                .commit()
    }
    ...
    private fun setupToolbar() {
        ...
        setToolbarTitle(getString(R.string.theming))
    }

    private fun showLandingPage() {
        supportFragmentManager.beginTransaction()
            .replace(R.id.design_activity_frame_layout, ThemingLandingPageFragment.newInstance())
            .commit()
    }
}